        ...
        <div className="py-12 md:py-16 grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Mentoria exclusiva para Profissionais de Educação Física que querem se especializar em acompanhamento de alunos que usam ou usaram medicamentos emagrecedores.
            </p>
          </div>
